...
|---------|-------------|--------|
| **[SOL Staking](about/services.md#sol-staking)** | - [Native Staking](about/validator.md) <br> - [LST Staking](https://app.sanctum.so/stake/dawnSOL) <br> - [Kamino LST Multiple](multiple-staking/kamino-lst-multiple.md) <br> - [Jupiter Native Stake Multiple](multiple-staking/jupiter-native-stake-multiple.md) <br> 0% commission + kickback for VIPs | Live |
